  ...
  <ul :class="containerClass" v-if="!noLiSurround">
    ...
    >
      <Link @click="prevPage()"
         ...
         :tabindex="firstPageSelected() ? -1 : 0"
         v-html="prevText"
         :href="getPageLink(this.selected - 1)"
      ></Link>
    </li>
    ...
    <li v-if="firstLastButton" :class="[pageClass, lastPageSelected() ? disabledClass : '']">
      <Link @click="selectLastPage()"
         @keyup.enter="selectLastPage()"
         :class="pageLinkClass"
         :tabindex="lastPageSelected() ? -1 : 0"
         v-html="lastButtonText"
         :href="getPageLink(this.pageCount)"
      ></Link>
    </li>
  </ul>

  <div :class="containerClass" v-else>
    <Link v-if="firstLastButton"
       ...
       :href="getPageLink(1)"
    ></Link>
    <Link v-if="!(firstPageSelected() && hidePrevNext)"
       @click="prevPage()"
       @keyup.enter="prevPage()"
    ...
    <template v-for="page in pages">
      ...
      <Link v-else
         ...
         tabindex="0"
         :href="getPageLink(page.index + 1)"
      >{{ page.content }}</Link>
    </template>
    <Link v-if="!(lastPageSelected() && hidePrevNext)"
       @click="nextPage()"
       @keyup.enter="nextPage()"
...
export default {
  ...
  methods: {
    ...
    getPageLink(pageNo) {
      return this.path + '?page=' + pageNo.toString()
    }
  },
  beforeMount() {
